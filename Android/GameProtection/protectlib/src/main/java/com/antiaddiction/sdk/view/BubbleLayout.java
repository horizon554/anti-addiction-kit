...
//参考链接：https://github.com/xujiaji/HappyBubble
...
public class BubbleLayout extends FrameLayout
{
    ...
    private void initAttr()
    {
        mLook = Look.BOTTOM;
        mLookPosition = 0;
        mLookWidth = UnitUtils.dpToPx(getContext(), 17);
        mLookLength = UnitUtils.dpToPx(getContext(), 17);
        mShadowRadius = UnitUtils.dpToPx(getContext(), 4);
        mShadowX =  UnitUtils.dpToPx(getContext(), 1);
        mShadowY = UnitUtils.dpToPx(getContext(), 1);
        mBubbleRadius = UnitUtils.dpToPx(getContext(), 7);
        mBubblePadding =UnitUtils.dpToPx(getContext(), 8);
        mShadowColor = Color.GRAY;
        mBubbleColor = Color.WHITE;
    }
